...
public class MyBrowsers {
    ...
    public final String MAIN_RESOURCES_DIR = "src/main/resources/";
    public final String DOWNLOAD_DIR = MAIN_RESOURCES_DIR.concat("download/");
    public final String SCREENSHOTS_DIR = MAIN_RESOURCES_DIR.concat("screenshots/");
    public final String REPORTS_DIR = MAIN_RESOURCES_DIR.concat("reports/");
